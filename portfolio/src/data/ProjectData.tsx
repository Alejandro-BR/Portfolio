  ...
  return [
    {
      ...
      images: [
        ...
        "/img/lz_agent.webp",
        "/img/lz_agent2.webp",
        "/img/lz_hardvisionai-demo.webp",
        "/img/lz_reviews_admin.webp",
        "/img/lz_reviews_user.webp",
      ],
      techs: [
    ...
    {
      slug: "webpify-docker",
      title: "Webpify Docker",
      description: t("webpifyDockerDescription"),
      images: ["/img/docker.webp", "/img/cmd1.webp"],
      techs: [
        { name: "JavaScript", icon: "/svg/tech/javascript.svg" },
        { name: "Node.js", icon: "/svg/tech/nodejs.svg" },
      ...
      links: {
        github: "https://github.com/Alejandro-BR/Webpify-docker",
        docker: "https://hub.docker.com/r/alejandrobr/webpify",
      },
      features: t("webpifyDockerFeatures", { returnObjects: true }) as string[],
    },
    {
      slug: "autonext-code",
      title: "AutoNext Code",
